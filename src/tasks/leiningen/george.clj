...
(defn- spit-module-info []
  (let [reqs (apply str  (map #(str "    requires " (name %) ";\n")  (modules)))
    ...
    (println java)
    (spit "src/main/java/module-info.java" java)))


(defn- delete-module-info []
  (cio/delete-file "src/main/java/module-info.java" true))
...
(defn- tasks 
  ...
  []
  (->> (blt/namespaces-on-classpath :prefix "leiningen" :classpath "src/tasks")
